...
We’ll be analyzing the `biopsy` dataset, which comes originally from the MASS package. It is a breast cancer dataset from the University of Wisconsin Hospitals, Madison from Dr. William H. Wolberg. The data consists of 683 observations (rows) and 10 variables (columns), and it appears to be a tidy dataset.
...
pca_fit_eigenvalues |> 
  ...
  labs(title = "Variance Explained by Each Principal Component of Biopsy Data")
```
